...
const navItems: NavItem[] = [
  {
    icon: <GridIcon />,
    name: "Dashboard",
    subItems: [{ name: "Ana Sayfa", path: "/", pro: false }],
  },
  {
    icon: <BoxCubeIcon />,
    name: "Ürünler",
  ...
  },
  {
    ...
    name: "Siparişler",
    subItems: [
      { name: "Tüm Siparişler", path: "/orders", pro: false },
      { name: "Bekleyen Siparişler", path: "/orders/pending", pro: false },
    ],
  },
  {
    icon: <UserCircleIcon />,
...
const othersItems: NavItem[] = [
  {
    ...
    name: "Raporlar",
    subItems: [
      { name: "Satış Raporları", path: "/reports/sales", pro: false },
      { name: "Gelir Raporları", path: "/reports/revenue", pro: false },
    ],
  },
  {
    icon: <UserCircleIcon />,
